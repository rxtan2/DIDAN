...
class Batch(object):
    ...
    def __init__(self, data=None, device=None, is_test=False):
        ...
        if data is not None:
            ...
            print('mask_tgt: ' + str(mask_tgt.shape))
            sys.exit()'''
...
def load_dataset(args, corpus_type, shuffle):
    ...
    pts = sorted(glob.glob('/research/rxtan/PreSumm/bert_data/cnndm' + '.' + corpus_type + '.[0-9]*.bert.pt'))
    if pts:
        if (shuffle):
            random.shuffle(pts)
        ...
        pt = '/research/rxtan/PreSumm/bert_data/cnndm.train.45.bert.pt'
        yield _lazy_dataset_loader(pt, corpus_type)
